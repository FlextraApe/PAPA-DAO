    ...
    <div className={"warm-up MuiPaper-root papa-card "}>
      <>
        <div className="card-header header">
          ...
          <Tooltip
            arrow
            title="Choosing to Exit Warmup will return your original PAPA amount without any of the accumulated rewards for the first 2 rebases."
            ...
            {warmupRebaseTime >= 1 ? (
              <>
                ...
                <Button
                  ...
                  onClick={onFofeit}
                >
                  {txnButtonText(pendingTransactions, "forfeiting", "Exit Warmup")}
                </Button>
              </>
            ) : (
              <Button
