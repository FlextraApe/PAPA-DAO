...
function Stake() {
  ...
  modalButton.push(
    <Button variant="outline" color="primary" className="connect-button" onClick={connect} key={1}>
      Connect Wallet
    </Button>,
  );
                  ...
                  <>
                      ...
                      {depositAmount == 0 ?
                        ...
                        <>
                          ...
                          <div className="data-row">
                            ...
                            <Typography variant="body1" className="text-right">
                              {warupRebaseTime >= 1 ? 
                                <>{isAppLoading ? <Skeleton width="80px" style={{marginLeft:"auto"}}/> : <>{trim(warupRebaseTime, 4)} Rebase(s) left till claimable</>}
                                ...
                                <Button 
                                  ...
                                  {/* <Button className="exit-button" variant="outlined" color="primary" onClick={handleOpen}> EXIT Warm Up </Button>
                                  <Modal
                                    open={open}
                                    onClose={handleClose}
                                  >
                                    <Box sx={style}>
                                      ...
                                      <Typography>
                                        Exiting Warm-Up will return your PAPA balance to your account, but will not make you eligible for rebases on the current balance in warm-up.
                                      </Typography>
                                    </Box>
                                  </Modal> */}
                                </div>
                    ...
                    <Box className="stake-warmup-text " display="flex" alignItems="center">
                      <Typography variant="body2" className="stake-note1" color="textSecondary">
                        Note: There is a 2 epoch warm-up staking period, 
                        where users must be staked for more than 2 epoch/rebase before claiming any rebase rewards. 
                        Users will accumulate rewards while in the warm-up period but will not be able to claim them for 2 epoch. 
                        When 2 epoch has elapsed your staked balance can be claimed from the warm up contract and you will 
